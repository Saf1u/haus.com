...
import (
	...
	"github.com/saf1u/haus.com/pkg/client/clientset/versioned/scheme"
...
func (c *SamplecontrollerV1Client) Hauses(namespace string) HausInterface {
	return newHauses(c, namespace)
}
